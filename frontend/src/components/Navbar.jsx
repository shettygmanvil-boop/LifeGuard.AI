  ...
  return (
    <nav className="bg-slate-900 border-b border-slate-800 px-6 py-4 flex justify-between items-center sticky top-0 z-50">
      ...
      <div className="hidden md:flex gap-8 text-slate-300 font-medium text-sm">
        ...
        <Link to="/predict" className="hover:text-emerald-400 transition-colors">Predict</Link>
        {user && <Link to="/dashboard" className="hover:text-emerald-400 transition-colors">Dashboard</Link>}
        <Link to="/hospitals" className="hover:text-emerald-400 transition-colors">Hospitals</Link>
        {user && <Link to="/profile" className="hover:text-emerald-400 transition-colors">Profile</Link>}
      </div>
